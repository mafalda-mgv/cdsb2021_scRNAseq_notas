usethis::use_r("05_control-de-calidad.R")
...
#Yo colectaria la primera fila del objeto sce.416b en una df
#nombre<-colData(sce.416b[,2]) #da un poco igual que fila. Lo importante es que
#asi obtienees una fila con los nombres de las columnas. Esto es una df
#para obtener los nombres de las columnas, usas la función
#colnames(nombre) y asi sabes que información hay en el objeto sce.416b

#ahora si puedes decidir que plotear para los QC
...
plotColData(sce.416b,
  ...
  #scale_y_log10() +  # Esta line hay que saber si la usas o no
  facet_wrap(~phenotype)
